...
/// GetAssetListRequest
/// </summary>
public class GetAssetListRequest : RequestBase<CvListResponse<AssetResponse>>
{
    /// <summary>
    /// 프로필아이디
    /// </summary>
...
{
    public GetAssetListRequestValidator(IWorldSettingHelper worldSettingHelper)
    {
